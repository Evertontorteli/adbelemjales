...
const DEPARTAMENTOS = [
  {
    ...
    title: 'Ação Social',
    description:
      'Ação social é um trabalho crucial. Gálatas 6:10 diz: Portanto, enquanto temos oportunidade, façamos o bem a todos, especialmente aos da família da fé. Em "fazer o bem" está incluso uma palavra de conforto, oferecer o alimento e suporte necessário a quem está em dificuldades. Por isso, sua ajuda é muito importante, seja mantenedor desta obra e faça famílias felizes.',
    color: 'from-rose-500/90 to-pink-600/90',
  },
  {
    id: 'circulo-oracao',
    icon: Users,
    title: 'Círculo de Oração (UFADJA)',
    description:
      'O departamento UFADJA visa trabalhar efetivamente com as mulheres da igreja, através de palestras, encontros, chás e reuniões exclusivas para o desenvolvimento individual e coletivo. Nosso objetivo é ajudar as mulheres a melhorar como mãe, esposa, filha e pessoa, tanto dentro da igreja como fora dela.',
  ...
  },
  {
    ...
    description:
      'O Curso de Teologia tem o intuito de treinar o aluno através do estudo das principais questões teológicas da fé cristã, passando o conhecimento da palavra de Deus de forma profunda e sistemática, para defender a sua fé e obter crescimento espiritual com professores graduados e capacitados.',
    color: 'from-red-500/90 to-rose-600/90',
  },
  {
    id: 'departamento-infantil',
    icon: Baby,
    title: 'Departamento Infantil (DIA)',
    description:
      'DIA trabalha no cuidado das nossas crianças. Para isso, temos material didático exclusivo para cada faixa etária, professores capacitados para ensinar e salas mobiliadas, pensadas em cada detalhe para recebê-las. Provérbios 22:6 diz: "Ensine a criança no caminho em que deve andar, e até quando envelhecer não se desviará dele". Seguimos essa palavra à risca e investimos no futuro cristão de nossas crianças!',
  ...
  },
  {
    ...
    title: 'Discipulado',
    description:
      'A igreja do Senhor vem sofrendo cada vez mais evasões de cristãos que se afastaram de Deus, após aceitarem a Jesus Cristo. O curso de mentoria para novos convertidos foi criado justamente para suprir essa demanda, firmando o cristão na rocha.',
  ...
  },
  {
    ...
    description:
      'Na vida somos eternos alunos. Possuímos classes para crianças, jovens e adultos, sejam eles novos convertidos ou membros, para que todos tenham acesso ao ensino bíblico de qualidade. Venha estar conosco!',
    color: 'from-indigo-500/90 to-purple-600/90',
  },
  {
    id: 'equipe-louvor',
    icon: Music,
    title: 'Equipe de Louvor Dádiva Sagrada',
    description:
  ...
  },
  {
    id: 'umadej',
    icon: Users,
    title: 'Grupo de Jovens (UMADEJ)',
    description:
      'UMADEJ tem como objetivo auxiliar os jovens a desenvolver sua identidade em Cristo e promover o crescimento espiritual. Com o Congresso da UMADEJ, realizado uma vez por ano, buscamos unir a juventude. Jovens alinhados em um só propósito: servir a Deus em união, adorar a Ele, lutar contra o pecado e levar vidas para o Céu.',
    color: 'from-orange-500/90 to-red-600/90',
  },
  {
    id: 'missoes',
    icon: Globe,
    title: 'Missões Graça para Todos',
    description:
      'A Missão Graça para Todos é um departamento que atua de forma direta e estratégica para ajudar a igreja. Além de acolhimento a cristãos refugiados no Brasil e ao redor do mundo, a Graça Para Todos desenvolve projetos de treinamentos, eventos e congressos buscando sempre ações que possam fortalecer a Igreja e pregar as boas novas a toda criatura.',
    color: 'from-sky-500/90 to-blue-600/90',
  },
  {
    id: 'orquestra',
    icon: Music,
    title: 'Orquestra Louvores Celestes',
    description:
      'Orquestra Louvores Celestes é um diferencial no nosso templo hoje, com músicos voluntários e capacitados em apresentar o melhor para Deus e nos proporcionar uma experiência única através dos louvores apresentados. Um compromisso que o maestro tem com o ministério é oferecer aulas gratuitas a todos com o desejo de aprender.',
    color: 'from-fuchsia-500/90 to-pink-600/90',
  },
  {
    id: 'unidos-para-sempre',
    icon: Handshake,
    title: 'Unidos Para Sempre',
    description:
      'O Ministério de Casais busca apoiar, aconselhar, incentivar e resgatar as famílias através da integração dos casais e do desenvolvimento do testemunho cristão. Os frutos deste trabalho podem ser vistos em diversos lares que foram transformados, restaurados e curados pelo poder de Cristo.',
...
export default function Departamentos() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#FAF8F5] to-[#F0EBE3] pt-24 pb-40 md:pt-28 md:pb-24">
      <div className="max-w-5xl mx-auto px-4 relative">
        ...
        <header className="text-center mb-20 md:mb-24 relative z-10">
          <span className="text-[#5C4033] tracking-widest uppercase text-sm font-medium">
            Ministérios
          </span>
          <h1 className="text-[#5C4033] text-3xl md:text-5xl mt-2 mb-4 font-semibold tracking-tight">
            DEPARTAMENTOS
          </h1>
          <p className="text-[#666666] text-lg max-w-2xl mx-auto mb-0">
          ...
          {DEPARTAMENTOS.map((dept) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div>
                    <Icon className="w-5 h-5 md:w-6 md:h-6 text-[#5C4033]" aria-hidden />
                  </div>
                  <h2 className="text-[#5C4033] text-lg md:text-xl font-semibold leading-tight">
                    {dept.title}
                  </h2>
        ...
        >
          <div className="rounded-2xl border border-[#E8E0D5] bg-white px-10 py-12 md:px-14 md:py-16 shadow-md max-w-2xl mx-auto">
            <h3 className="text-[#5C4033] text-xl md:text-2xl font-semibold mb-4">
              Quer fazer parte de um ministério?
            </h3>
            <p className="text-[#666666] text-base md:text-lg leading-relaxed mb-8 max-w-xl mx-auto">
              Entre em contato conosco e descubra como você pode servir e crescer em comunidade.
            </p>
            <a
              href="/#redes-sociais"
              className="inline-flex items-center gap-2 bg-[#E8E0D5] hover:bg-[#D4C4B0] text-[#1a1a1a] px-6 py-3 rounded-full transition-all shadow-lg border border-[#8B7355]/30"
            >
