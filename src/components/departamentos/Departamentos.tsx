    ...
    >
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-12">
          <span className="text-[#484440] tracking-widest uppercase text-sm">Ministérios</span>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-[#E8E0D5] p-6 md:p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 rounded-full bg-[#8B7355]/20 flex items-center justify-center">
              <Users className="w-6 h-6 text-[#484440]" />
            </div>
            <h3 className="text-[#484440] text-xl font-medium">Nossos departamentos</h3>
          </div>
          <p className="text-[#484440] text-base leading-relaxed mb-6">
