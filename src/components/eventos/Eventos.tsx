...
export function Eventos() {
  return (
    <section
      id="eventos"
      className="py-16 md:py-24 px-4 bg-gradient-to-b from-white to-[#F5F0E8] relative overflow-hidden"
    >
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-[#E8E0D5] p-6 md:p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 rounded-full bg-[#8B7355]/20 flex items-center justify-center">
              <Calendar className="w-6 h-6 text-[#5C4033]" />
            </div>
            <h3 className="text-[#333333] text-xl font-medium">Programação</h3>
          </div>
