        ...
        <div className="bg-white rounded-2xl shadow-lg border border-[#E8E0D5] overflow-hidden">
          <div className="bg-[#E8E0D5] border-b border-[#E8E0D5] p-6 text-center">
            <div className="inline-flex items-center justify-center w-14 h-14 bg-[#8B7355]/20 rounded-full mb-4">
              <Share2 className="w-7 h-7 text-[#5C4033]" />
            </div>
            <h3 className="text-[#1a1a1a] text-xl md:text-2xl font-medium">@adbelemjales</h3>
          </div>
          <div className="p-6 md:p-8">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-[#E8E0D5] hover:bg-[#D4C4B0] text-[#1a1a1a] px-6 py-3 rounded-full transition-all border border-[#8B7355]/30"
              >
                Instagram
              </a>
              <a
