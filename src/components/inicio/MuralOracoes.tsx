    ...
    >
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-12">
          <span className="text-[#5C4033] tracking-widest uppercase text-sm">Comunidade</span>
        ...
        <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg border border-[#E8E0D5] mb-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 rounded-full bg-[#8B7355]/20 flex items-center justify-center">
              <Heart className="w-6 h-6 text-[#5C4033]" />
            </div>
            <div>
              <h3 className="text-[#333333] text-xl font-medium">Pedidos de oração</h3>
              <p className="text-[#666666] text-sm">Seus pedidos são acolhidos com carinho</p>
            </div>
          </div>
